package com.leeej.event_reservation.service;

import com.leeej.event_reservation.dto.EventDto;
import com.leeej.event_reservation.dto.ReservationDto;
import com.leeej.event_reservation.model.Event;
import com.leeej.event_reservation.model.Reservation;
import com.leeej.event_reservation.repository.EventRepository;
import com.leeej.event_reservation.repository.ReservationRepository;
...
public class ReservationService {
    ...
    public Reservation create(Long eventId, ReservationDto reservationDto) {
        Event event = eventRepository.findById(eventId).orElseThrow(
                () -> new NoSuchElementException("이벤트 없음")
        );
    ...
    public Reservation update(Long id, ReservationDto reservationDto) {
        Reservation existReservation = reservationRepository.findById(id).orElseThrow(
                () -> new NoSuchElementException("예약 없음")
        );
